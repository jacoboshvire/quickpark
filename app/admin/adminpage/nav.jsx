  ...
  return (
        <header>
          <div className="adminnav">
            ...
            <Link className={pathname === "/admin/adminpage" && searchParams.get("sendnotification") !== "true" && searchParams.get("users") !== "true"  ? "active sendNotification" : "sendNotification"} href={"/admin/adminpage"}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.0787 16.1354H14.8937"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path fillRule="evenodd" clipRule="evenodd" d="M2.4 13.713C2.4 8.082 3.014 8.475 6.319 5.41C7.765 4.246 10.015 2 11.958 2C13.9 2 16.195 4.235 17.654 5.41C20.959 8.475 21.572 8.082 21.572 13.713C21.572 22 19.613 22 11.986 22C4.359 22 2.4 22 2.4 13.713Z"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <p>
                Home
              </p>
            ...
            <Link className={isActive("/admin/adminser") ? "active adminuser" : "adminuser"} href={"/profile"}>
              <div className="adminuserimg">
                <Image 
                  alt="user"
                  src={userData.avatar ? userData.avatar : "https://res.cloudinary.com/dr0yyqvj6/image/upload/v1765055574/avatar_l6mc3s.png"}
                  width={40}
                  height={40}
                />
              </div>
